    ...
    <section className="bg-gradient-to-r from-pink-100/50 via-purple-100/50 to-blue-100/50 py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div className="group w-full h-full">
              <div className="relative h-full">
                <img
                  ...
                  alt="ContactUs"
                  className="w-full  lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700  h-[500px]"
                />
          ...
          <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl h-[500px] shadow-2xl border">
            <input
              type="text"
            ...
            <textarea
              className="w-full h-12 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-lg border border-gray-200 focus:outline-none pl-4 mb-10"
              placeholder="Message"
            ></textarea>
